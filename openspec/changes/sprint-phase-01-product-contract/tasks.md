# Sprint Phase 1 checklist

- [x] Record the exact canonical baseline and inherited failures.
- [x] Pin and verify the Ralphy and Unlazy revisions.
- [x] Reconcile the npm lockfile with existing manifests.
